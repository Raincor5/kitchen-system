...
export default function TabTwoScreen() {
  ...
  // New: Finish Prepping button – navigates to the GN Organizer screen.
  const openGNOrganizer = () => {
    // GNOrganizerScreen will use the DishesContext to access all current prep bag data.
    router.push("/gn-organizer");
  };
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 250 }}>
        ...
        <View style={styles.tickOffSection}>
          ...
          <View style={styles.tickOffOptions}>
            <Pressable style={styles.tickOffOptionButton} onPress={() => openTickOffSheet('dish')}>
              <Text style={styles.tickOffOptionText}>Tick Off Ingredients from a Dish</Text>
            </Pressable>
            <Pressable style={styles.tickOffOptionButton} onPress={() => openTickOffSheet('all')}>
        ...
        {/* Finish Prepping Button */}
        <View style={styles.finishPreppingContainer}>
          <TouchableOpacity style={styles.finishPreppingButton} onPress={openGNOrganizer}>
            <Text style={styles.finishPreppingText}>Finish Prepping</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
          ...
          {tickOffMode === 'all' && (
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <View style={styles.sheetInnerContainer}>
                ...
                <Pressable
                  style={[styles.tickOffConfirmButton, tickedIngredients.length === 0 && styles.disabledButton]}
          ...
          {tickOffMode === 'dish' && (
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <View style={styles.sheetInnerContainer}>
                ...
                <Pressable
                  style={[styles.tickOffConfirmButton, !selectedTickOffDish && styles.disabledButton]}
                  onPress={handleConfirmTickOff}
...
const styles = StyleSheet.create({
  ...
  finishPreppingContainer: {
    marginVertical: 20,
    alignItems: 'center',
    justifyContent: 'center',
  },
  finishPreppingButton: {
    backgroundColor: '#4CAF50',
    paddingVertical: 14,
